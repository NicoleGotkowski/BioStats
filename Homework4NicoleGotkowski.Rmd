...
```{r}
#Question#5
data.frame(my.variables.nona)
model1<-glm(survival~age+fare+Parents.children+Gender+Class+Residence)
summary.lm(model1)
```
```{r}
#The best variables to use in the model are age, class, fare, residence and gender
```
